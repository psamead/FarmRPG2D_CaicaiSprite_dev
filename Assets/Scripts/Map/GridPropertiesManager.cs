...
public class GridPropertiesManager : SingletonMonobehavior<GridPropertiesManager>, ISaveable
{
    ...
    {
        //Get wheter surrounding tiles (up, down, left and right) are dug or not
    ...
    public void ISaveableRestoreScene(string sceneName)
    {
        ...
        if (GameObjectSave.sceneData.TryGetValue(sceneName, out SceneSave sceneSave))
        {
            ...
            // get dictionary of bools - it exists since we created it in intialise
            ...
            // Instaniate any crop prefabs initially present in the scene
