...
public class InventoryManager : SingletonMonobehavior<InventoryManager>, ISaveable
{
    ...
    protected override void Awake()
    {
        ...
        // Initialized selected inventory item array
    ...
    private void CreateInventoryLists()
    {
        ...
        // initialize inventory list capactiy array
        inventoryListCapacityIntArray = new int[(int)InventoryLocation.count];

        // intialize player inventory list capacity
    ...
    {
        // if fromItem index and toItemIndex are within the bounds of the list, not the name, and greater then or equal to zero
